...
internal inline fun VersionCatalog.library(name: String): Provider<MinimalExternalModuleDependency> {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun VersionCatalog.version(name: String): VersionConstraint {
...
@Suppress("NOTHING_TO_INLINE")
internal inline fun VersionCatalog.plugin(name: String): String {
...
internal val Project.catalog
    get() = this.extensions.getByType<VersionCatalogsExtension>().named("foody")
